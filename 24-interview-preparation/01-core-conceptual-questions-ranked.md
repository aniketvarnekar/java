...
1. Pick five questions from this list at random. Answer each out loud, from memory, in under 45 seconds, before checking the model answer.
2. For Q11 (`HashMap` internals), extend your answer to also explain what happens on resize (Module 10) — a very common interviewer follow-up.
3. For Q19 (platform vs. virtual threads), practice a follow-up an interviewer is likely to ask: "when would you *not* want virtual threads?" (Hint: Module 15, Topic 8's CPU-bound-workload caveat.)

---

**Previous:** [00 — Module Overview](00-module-overview.md) · **Next:** [02 — Coding Problems & Live Coding](02-coding-problems-and-live-coding.md)
