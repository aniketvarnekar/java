...
1. Write code using Reflection to load a class by name (`Class.forName`), list all its declared fields and their types, and create a new instance via its no-arg constructor.
2. Write code using Reflection to invoke a `private` method on an object, using `setAccessible(true)`, and explain the real trade-off this represents.
3. Explain, in your own words, how a JSON-to-object deserialization library could use Reflection to populate a class's fields, without ever having compile-time knowledge of that specific class.

---

**Previous:** [03 — Java Memory Model Deep Dive](03-Java-Memory-Model-Deep-Dive.md) · **Next:** [05 — Annotations & Dynamic Proxies](05-Annotations-And-Dynamic-Proxies.md)
