...
1. Explain in your own words why HotSpot uses two separate JIT compilers (C1 and C2) instead of just always using the more heavily-optimizing one.
2. What does it mean for the JVM to "de-optimize" a method, and under what circumstance would that happen?
3. If you were benchmarking two different implementations of the same method to see which is faster, why would measuring only the very first call to each be misleading? What Execution Engine behavior explains this?

---

**Previous:** [03 — Runtime Data Areas](03-Runtime-Data-Areas.md) · **Next:** [05 — Native Method Interface (JNI)](05-Native-Method-Interface.md)
