...
1. Explain, using a concrete example, how two libraries depending on different versions of the same shared dependency could cause a runtime error, even though everything compiled successfully.
2. Explain why a library author might be forced to mark an internal helper class `public`, even though they never intended external code to use it — and why this created a real, fragile coupling problem.
3. Explain, in your own words, why the JDK team's inability to safely refactor internal classes (like `sun.misc.*`) was a genuine, real cost of the pre-JPMS encapsulation model.

---

**Previous:** [00 — Module Overview](00-module-overview.md) · **Next:** [02 — Module Descriptors & Directives](02-module-descriptors-and-directives.md)
