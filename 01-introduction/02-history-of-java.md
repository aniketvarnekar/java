...
1. Explain in 2–3 sentences why Java pivoted from consumer electronics to the web in the mid-1990s, and what property of the language made that pivot possible.
2. What is the difference between a regular feature release and an LTS release? Why would a company deliberately choose to stay on an older LTS instead of always using the newest Java version?
3. Pick any two features you've heard of in modern Java (e.g., records, var, switch expressions) — we'll cover all of these later — and guess which era (pre-2017 or post-2017) they belong to, based on the philosophy described in this section. We'll confirm your guesses in Module 23.

---

**Previous:** [01 — What Is Java?](01-what-is-java.md) · **Next:** [03 — Features of Java](03-features-of-java.md)
