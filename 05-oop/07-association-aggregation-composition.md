...
2. Why is a `private` field with a trivial, validation-free setter not meaningfully encapsulated?
3. Why does Java disallow multiple class inheritance, precisely?
4. Which is resolved at compile time — overloading or overriding? Which at runtime?
5. Can an interface have instance fields with mutable state? Why or why not?
6. What's the key distinguishing factor between aggregation and composition?

*(Answers are derivable from Topics 2, 2, 4, 5, 6, and 7 respectively.)*

---

**Previous:** [06 — Interfaces & Abstract Classes](06-interfaces-and-abstract-classes.md) · **Next:** [08 — Module Summary, Interview Questions & Exercises](08-module-summary-exercises.md)
