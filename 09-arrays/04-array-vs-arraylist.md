...
1. Is an array a primitive type or an object in Java?
2. What does `int[][] grid = new int[3][];` create, precisely?
3. Why does `Arrays.binarySearch` require its input to already be sorted?
4. What does `Arrays.asList(arr).add(x)` do, and why?
5. Internally, how does `ArrayList` implement its "dynamic" resizing?

*(Answers are derivable from Topics 1, 2, 3, 4, and 4 respectively.)*

---

**Previous:** [03 — The `Arrays` Utility Class](03-arrays-utility-class.md) · **Next:** [05 — Module Summary, Interview Questions & Exercises](05-module-summary-exercises.md)
