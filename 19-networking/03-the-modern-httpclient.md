...
2. Why does socket I/O use the same API as file I/O?
3. What one-line change resolves the C10K problem for a thread-per-connection server, and why?
4. What does `HttpClient.sendAsync(...)` return?
5. Why is `HttpClient` preferred over the legacy `HttpURLConnection`?

*(Answers are derivable from Topics 1, 1, 2, 3, and 3 respectively.)*

---

**Previous:** [02 — Building Servers & Handling Multiple Clients](02-building-servers-and-handling-multiple-clients.md) · **Next:** [04 — Module Summary, Interview Questions & Exercises](04-module-summary-exercises.md)
